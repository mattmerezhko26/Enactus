function generatePageJsonLd(pageType, pageDetails = {}) {
  const baseJsonLd = {
    ...
    description:
      'As a proud member of Enactus Canada, Enactus Seneca Polytechnic operates as an experiential learning platform dedicated to creating a better world through the development of entrepreneurial leaders and social innovators. We are a vibrant community of students, professors, and industry leaders who collaborate on entrepreneurial projects that not only lead to business success but also generate social impact.',
    foundingDate: '2024',
    founders: [
      {
        '@type': 'Person',
    ...
    sameAs: ['https://www.linkedin.com/company/enactus-senecapolytechnic/', 'https://twitter.com/EnactusSeneca'],
    location: {
      '@type': 'Place',
      name: 'Seneca College',
      address: {
